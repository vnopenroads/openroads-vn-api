...
INSERT INTO cba_user_configs
  VALUES (1, 'Default', 0.12, 0.91, 2022, '[]','[]','[]','[]'),
         (2, 'DiscountRate 14%', 0.14, 0.91, 2022, '[]','[]','[]','[]'),   
         (3, 'DiscountRate 16%', 0.16, 0.91, 2022, '[]','[]','[]','[]'),
         (4, 'Work Cost -10%', 0.12, 0.91, 2022, '[]','[]','[]','[]'),
         (5, 'Work Cost -20%', 0.12, 0.91, 2022, '[]','[]','[]','[]');
