...
// const UserConfig = require('../../models/cba/user-config.js')
...
//             var cbaConfig = selectQuery(res, 1, ['discount_rate', 'economic_factor']).resolve();
//             console.log("=--------=");
//             console.log(cbaConfig);
//             console.log("=--------=");
//             var opts = {
//                 method: 'POST',
//                 body: JSON.stringify({ config: {}, assets: response }),
//                 headers: { 'Content-Type': 'application/json' }
//             };
//             return fetch(url, opts)
