...
# usage: ./utils/won-import <shapefile.shp> <api url>
# example: ./utils/won-import cam-thuy.shp http://localhost:4000
...
python openroads-data/bin/ogr2osm/ogr2osm.py $1 --add-user="openroads" --add-version  --create-changeset --force --add-timestamp -o /tmp/won.osm
